...
-- Function to reconnect game objects after respawn
local function ReconnectGameObjects()
    Mobs = workspace:WaitForChild("__Main"):WaitForChild("__Enemies")
    DungeonFolder = workspace:WaitForChild("__Main"):WaitForChild("__Dungeon")
    DetectDungeonRod()
